...
class FormFieldTextarea extends AbstractFormField {
    ...
    /**
     * @brief Add a static caption to textarea
     * @param type $field 
     */
    protected function decorate($field) {
        
        $pretty_field = '<p>Your message</p>';
        
        return $pretty_field . parent::decorate($field);
    }
    
    /**
     * @brief Basic render for the textarea!
     */
    function render() {
        ...
        return $this->decorate("<textarea name='$name' class='$class'></textarea>"); 
    }
}
